    ...
    public func materialize(events _: ViewableEvents) -> (UIButton, Disposable) {
        ...
        func updateStyle(buttonType: ButtonType) {
            styleSignal.value = ButtonStyle.default.restyled { (style: inout ButtonStyle) in
                ...
                let backgroundColor = buttonType.backgroundColor.withAlphaComponent(
                    buttonType.backgroundOpacity
                )
        ...
        func updateHighlightedStyle(buttonType: ButtonType) {
            highlightedStyleSignal.value = ButtonStyle.default.restyled { (style: inout ButtonStyle) in
                ...
                if buttonType.backgroundColor.isLight() {
                    backgroundColor = buttonType.backgroundColor.darkened(amount: 0.05)
                        .withAlphaComponent(buttonType.highlightedBackgroundOpacity)
                } else {
                    backgroundColor = buttonType.backgroundColor.lighter(amount: 0.10)
                        .withAlphaComponent(buttonType.highlightedBackgroundOpacity)
                }
        ...
        func updateDisabledStyle(buttonType: ButtonType) {
            disabledStyleSignal.value = ButtonStyle.default.restyled({ (style: inout ButtonStyle) in
                ...
                if buttonType.backgroundColor.isLight() {
                    backgroundColor = buttonType.backgroundColor.darkened(amount: 0.05)
                        .withAlphaComponent(buttonType.disabledBackgroundOpacity)
                } else {
                    backgroundColor = buttonType.backgroundColor.lighter(amount: 0.10)
                        .withAlphaComponent(buttonType.disabledBackgroundOpacity)
                }
